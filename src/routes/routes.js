...
const {getMain,postLogin,getLoginAdmin,getLoginInstructor,getAddFicha,postAddFicha,postUpdateModal,postDeleteModal,getAprendices,postAddAprendices,postDeleteAprendices,getAddInstructor,postAddInstructor,getUpdateAprendiz} = require('../presentation/controller/user.controller')
...
router.get('/',currentUrl,getMain)
    ...
    .get('/addInstructor',authToken,currentUrl,getAddInstructor)
    .get('/updateAprendiz',authToken,currentUrl,getUpdateAprendiz)
    ...
    .post('/addInstructor',authToken,currentUrl,postAddInstructor)
